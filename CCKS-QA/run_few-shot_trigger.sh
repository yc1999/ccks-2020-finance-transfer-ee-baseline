...
do
  ...
  do
    ...
    CACHE_DIR="few-shot_cache/$K-shot/group-$GROUP"
    ...
    CUDA_VISIBLE_DEVICES=3 python fin_trigger_qa.py \
    --train_file ./dataset/trigger/$TRAIN_DATA \
    --dev_file ./dataset/trigger/$DEV_DATA \
    --train_batch_size 4 \
    --eval_batch_size 4 \
    --learning_rate 4e-5 \
    --num_train_epochs 10 \
    --output_dir output/fin_args_qa_thresh_output/trigger/$OUTPUT_DIR \
    --model_dir output/fin_args_qa_thresh_output/trigger/$OUTPUT_DIR/best-model \
    --nth_query 5 \
